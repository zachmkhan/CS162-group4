...
void Doodlebug::Move()
{
	...
	else if (yLocation -1 >= 0 && board[xLocation][yLocation - 1] != nullptr && board[xLocation][yLocation - 1]->getCritterType() == 'O')
	{
		board[xLocation][yLocation - 1] = board[xLocation][yLocation];		//The Doodlebug moves to the new space
		board[xLocation][yLocation] = nullptr;					//The Doodlebug's old space becomes null
		stepsSinceEating = 0;							//The counter is reset due to the eaten ant
	...
	else if (xLocation -1 >= 0 && board[xLocation - 1][yLocation] != nullptr && board[xLocation - 1][yLocation]->getCritterType() == 'O')
	{
		board[xLocation - 1][yLocation] = board[xLocation][yLocation];		//The Doodlebug moves to the new space
		board[xLocation][yLocation] = nullptr;					//The Doodlebug's old space becomes null
		stepsSinceEating = 0;							//The counter is reset due to the eaten ant
	...
	else
	{
		...
		//Moving Down
		case 1:
			if (yLocation +1 < row -1 && board[xLocation][yLocation + 1] == nullptr)
			{
				board[xLocation][yLocation + 1] = board[xLocation][yLocation];		//The Doodlebug moves to the new space
		...
		//Moving Right
		case 3:
			if (xLocation +1 < col -1 && board[xLocation + 1][yLocation] == nullptr)
			{
