...
void Ant::Move()
{
	...
	case 1:
		if (onboard(rowLocation, colLocation + 1) && board[rowLocation][colLocation + 1] == nullptr)
		{
			...
			std::cout << "Ant Old Row " << rowLocation << " Old Column " << colLocation << std::endl;
			colLocation += 1;														//The Ant moves right
			std::cout << "Row " << rowLocation << " Column " << colLocation << std::endl;
		}
		else
		{
			std::cout << "Ant can't move right" << std::endl;
		}
	...
	case 2:
		...
		{
			std::cout << "Ant can't move left" << std::endl;
		}
	...
	case 3:
		...
		{
			std::cout << "Ant can't move down" << std::endl;
		}
	...
	case 4:
		...
		{
			std::cout << "Ant can't move up" << std::endl;
		}
